...
루비 온 레일스(RoR)는 Ruby 프로그래밍 언어로 작성한 오픈 소스 웹프레임워크이다. 레일스의 모든 애플리케이션은 Ruby로 작성한. 루비 온 레일스는 생산성과 애자일(agile) 웹 개발 적용에 중점을 두고 있다.
...
*[원본글](http://adrianmejia.com/blog/2011/08/11/ruby-on-rails-architectural-design/) 해당 글을 번역하였습니다.*